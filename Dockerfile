...
#install web fieldbus configurator
    && 7z -t7z -r -v: x "/tmp/WebConfigurator_V1.0200.960.7z" -o/usr/lib/node_modules \
    && mv "/usr/lib/node_modules/WebConfigurator V1.0200.960" "/usr/lib/node_modules/WebConfigurator" \
